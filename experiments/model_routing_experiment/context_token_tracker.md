...
Requested-configuration canary prompt selection for 7B:
...
Requested-configuration canary prompt selection for 14B:
...
Requested-configuration canary prompt selection for 32B:
